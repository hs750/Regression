...
%   Detailed explanation goes here
    ...
    for fold = 1:5
        ...
        [theta,fval] = fminunc(@logisticLoss,theta, options);
        ...
        ClassRatePerFold(fold) = sum(correctClassify) / s;
    ...
    maxClassIndex = ClassRatePerFold == maxClass;
    ...
    function [LogLikelihood, GradOut] = logisticLoss(Theta) 
