...
%       features for each day.
    ...
    features = [
        ...
        (stockPriceData(currentDayIndex - 8, 3) - stockPriceData(currentDayIndex - 7, 3))';
        (stockPriceData(currentDayIndex - 9, 3) - stockPriceData(currentDayIndex - 8, 3))';
        (stockPriceData(currentDayIndex - 10, 3) - stockPriceData(currentDayIndex - 9, 3))';
    ];
